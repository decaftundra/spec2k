...
@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
            <h2>Edit Cage Code</h2>
            
            <form class="form-horizontal" method="POST" action="{{ route('cage-code.update', $cageCode->id) }}">
                {{ method_field('PUT') }}
                {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('cage_code') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="cage_code" type="text" class="form-control" name="cage_code" value="{{ old('cage_code', $cageCode->cage_code) }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('info') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <textarea id="info" name="info" rows="3" placeholder="" class="form-control" >{{ old('info', $cageCode->info) }}</textarea autofocus>
