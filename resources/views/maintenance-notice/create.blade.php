...
@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
            <h2>Create Maintenance Notice</h2>
            
            <form class="form-horizontal" method="POST" action="{{ route('maintenance-notice.store') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('contents') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control" id="contents" name="contents" rows="5">{{ old('contents') }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="checkbox">
                            <label>
                                ...
                                if (!empty($errors->all()) && !old('display')) {
                                    $checked = '';
                                } else {
                                    $checked = 'checked';
                                }
