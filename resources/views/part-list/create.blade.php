...
@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
            <h2>Create Excluded Part Number List</h2>
            ...
            <form class="form-horizontal" method="POST" action="{{ route('part-list.store', $location) }}">
                {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('parts') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control" rows="20" name="parts" placeholder="List of part numbers to exclude separated by a comma">{{ old('parts') }}</textarea>
