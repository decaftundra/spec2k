        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('location.update', $location->id) }}">
                ...
                <div class="form-group{{ $errors->has('plant_code') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="plant_code" type="text" class="form-control" name="plant_code" value="{{ old('plant_code', $location->plant_code) }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text" class="form-control" name="name" value="{{ old('name', $location->name) }}" autofocus>
                ...
                <div class="form-group{{ $errors->has('sap_location_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="sap_location_name" type="text" class="form-control" name="sap_location_name" value="{{ old('sap_location_name', $location->sap_location_name) }}" autofocus>
                    ...
                    <div class="col-md-6">
                        <select class="form-control" name="timezone">
                            ...
                            @foreach ($timezones as $timezone)
                                <?php $selected = old('timezone', $location->timezone) == $timezone ? 'selected' : ''; ?>
                    ...
                    <div class="form-group{{ $errors->has('cage_codes') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            @foreach ($cageCodes as $id => $code)
                                ...
                                <?php $checked = in_array($id, old('cage_codes', $locationCageCodes)) ? 'checked' : ''; ?>
