        ...
        <div class="col-xs-12">
            ...
            <div class="navbar-form">
                <form action="{{ request()->url() }}" method="GET">
					...
					<a href="{{ route('deleted.index', ['reset' => true]) }}" type="button" class="btn btn-info btn-sm"><i class="fas fa-sync-alt"></i> Reset</a>
                </form>  
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover" style="white-space:nowrap;">
                        ...
                        @foreach ($datasets as $dataset)
                            ...
                            <tr class="{{ $rowClass }}">
                                <td>
                                    <button type="button" role="button" title="Restore" class="btn btn-sm btn-success" onclick="restore('{{ $dataset->id }}');">
        ...
        function restore(id)
        {
        	...
        	$.ajax({
                ...
                success : function(data){
                    showStatusChangeAlert('restored');
                    setTimeout(function(){
