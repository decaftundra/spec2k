        ...
        <div class="col-xs-12">
            ...
            <div class="navbar-form">
                <form action="{{ request()->url() }}" method="GET">
					...
					<a href="{{ route('completed.index', ['reset' => true]) }}" type="button" class="btn btn-default btn-sm"><i class="fas fa-sync-alt"></i> Reset</a>
                </form>  
            </div>
                        ...
                        @foreach ($datasets as $dataset)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" role="button" title="Put on standby" class="btn btn-sm btn-warning" onclick="changeStatus({{ (int) $dataset->id }}, 'on_standby');">
                                        <i class="fas fa-pause"></i>
                                    </button>
                                    
                                    <button type="button" role="button" title="Delete" class="btn btn-sm btn-danger" onclick="changeStatus({{ (int) $dataset->id }}, 'deleted');">
            ...
            @else
                <p>No completed datasets found.</p>
            @endif
        </div>
    </div>
@endsection
