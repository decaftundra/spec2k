...
class CreatePowerBiToDoShopFindingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('power_bi_to_do_shop_findings', function (Blueprint $table) {
            $table->string('id')->index()->unique();
            $table->integer('plant_code')->index()->nullable()->default(NULL);
    ...
    {
        Schema::dropIfExists('power_bi_to_do_shop_findings');
    }
}
