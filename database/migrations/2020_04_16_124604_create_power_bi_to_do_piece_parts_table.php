...
class CreatePowerBiToDoPiecePartsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('power_bi_to_do_piece_parts', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('power_bi_to_do_piece_parts');
    }
}
